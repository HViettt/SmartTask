  ...
  return (
    <div className="max-h-96 overflow-y-auto scrollbar-thin">
      {order.map(type => {
        ...
        return (
          <div key={type}>
            <div className="px-4 py-2 bg-brand-base/40 border-b border-brand-border">
              <p className="text-[10px] font-mono font-bold text-brand-sub uppercase tracking-wider">
